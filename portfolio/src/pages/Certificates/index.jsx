    ...
    <div className="certificates-container">
      ...
      <div className="grid-cards">
        <CertificateCard
          ...
          alt={'Certificado de Design Responsivo'}
          title={'Design Responsivo'}
          description={
            'Certificação de design responsivo, obtida após executar diversos projetos provando meu conhecimento, através da plataforma Free Code Camp.'
          }
